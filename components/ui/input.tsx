  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-blue-500/40 focus-visible:ring-blue-500/20 focus-visible:ring-[3px]",
        "focus-visible:shadow-[0_0_0_3px_rgba(20,80,255,0.15),0_0_12px_rgba(20,80,255,0.1)]",
