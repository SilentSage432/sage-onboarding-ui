...
import { KeyRound, AlertCircle, CheckCircle2, XCircle } from "lucide-react";
...
export default function ArcRho2LodgePanel() {
  const { data, loading, error, unavailable } = useArcStatus("rho2");
  ...
  if (loading) {
    return (
      <div className="p-6 space-y-6">
        <h1 className="text-2xl text-white font-bold">Rho² Lodge</h1>
      ...
      <div className="p-6 space-y-6">
        ...
        >
          ...
          <p className="text-gray-400 text-sm mt-2">
            Rho² Lodge status information is not currently available. This is an observational panel and will display data when the service is connected.
          </p>
        </motion.div>
      </div>
    );
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">Rho² security chamber operational state</p>
          </div>
        </div>
