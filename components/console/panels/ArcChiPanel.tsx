  ...
  if (loading) {
    return (
      <div className="p-6 space-y-6">
        <h1 className="text-2xl text-white font-bold">Arc Chi</h1>
      ...
      <div className="p-6 space-y-6">
        ...
        >
          ...
          <p className="text-gray-400 text-sm mt-2">
            Arc Chi status information is not currently available. This is an observational panel and will display data when the service is connected.
          </p>
        </motion.div>
      </div>
    );
    ...
    <div className="p-6 space-y-6">
      ...
      >
        <div className="flex items-center gap-3">
          <X className="h-8 w-8 text-pink-400" />
          <div>
            <h2 className="text-white font-semibold text-lg">Status</h2>
            <p className="text-gray-400 text-sm">Arc Chi operational state</p>
          </div>
        </div>
