...
export default function ArcOmicronPanel() {
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl text-white font-bold">Arc Omicron</h1>
        ...
        <div className="flex flex-col items-center justify-center text-center space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-400 text-sm">
              This panel is read-only and displays Arc Omicron status when available.
            </p>
